...
1. Navigate to the page for [editing your project info](editing_a_project.md). The **Edit Project Info** button is shown from the [dashboard](accessing_and_managing_projects_from_the_dashboard.md) in the image below. You are also able to reach the page to edit your project from your [list of your projects](customizing_project_list_view.md) or the navigation bar when in your project.
